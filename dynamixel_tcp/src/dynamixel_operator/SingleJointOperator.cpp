...
{
    SingleJointOperator::SingleJointOperator(int id, int cw_lim_value, int ccw_lim_value, int sleep_time_millis, int moving_speed)
        : id(id), cw_lim_value(cw_lim_value), ccw_lim_value(ccw_lim_value), sleep_time_millis(sleep_time_millis), moving_speed(moving_speed), joint_status(X)
    {
    ...
    void SingleJointOperator::operate(ros::Publisher &target_publisher)
    {
